...
from PySide6.QtGui import QGuiApplication, QCursor, QAction
...
class MainWindow(QMainWindow):
    def __init__(self, p_theme, p_translator, p_setting, p_stock_list):
        super(MainWindow, self).__init__()

        self.theme = p_theme
        self.translator = p_translator
        self.setting = p_setting
        self.stock_list = p_stock_list
    ...
    def init_stock_info(self):
        self.ui.layout_body.addWidget(StockWidget(self.stock_list))
        self.ui.widget_2.setFixedHeight(0)
        self.ui.widget_2.setFixedWidth(0)
